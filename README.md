...
| Skill | What it covers |
| --- | --- |
| [`engineering-practices`](skills/engineering-practices/SKILL.md) | Time-tested workflows for everyday engineering tasks — testing, debugging, refactoring, database migrations, reliability, security — each with what agents get wrong, a procedure and a checklist, grounded in canonical sources |
