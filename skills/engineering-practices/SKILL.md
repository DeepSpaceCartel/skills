...
| Release engineering | Shipping a risky change; feature flags, canaries and rollback; long-lived branches | [release-engineering](references/release-engineering.md) | DORA, Hodgson (Feature Toggles), trunkbaseddevelopment.com, Google SRE |
